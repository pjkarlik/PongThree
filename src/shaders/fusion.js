...
THREE.RenderFragment = {
  ...
  fragmentShader: [
    ...
    "void main() {",
      ...
      "vec4 color = texture2D( tDiffuse, Coord / Dist);",
      "vec2 Coord2 = vec2(sin(q.x * 0.98), q.y);",
      "vec4 color2 = texture2D( tDiffuse, Coord2);",
      ...
      "gl_FragColor = vec4(",
        ...
        // "(color.r * 0.25) + (overlay.r * ( q.x * 1.0 * sin(q.x * 0.75) ) ),",
        // "(color.g * 0.45) + (overlay.g * ( q.x * 2.0 * sin(q.x * 0.5) ) ),",
        // "(color.b * 0.35) + (overlay.b * ( q.x * 1.0 / sin(q.x * 0.25) ) ),",
        // "(overlay.r),",
        // "(overlay.g),",
        // "(overlay.b),",
